...
import mi.minhazurrahman.inventorymanager.data.PhoneContract;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        decreaseButton = (ImageButton) findViewById(R.id.decrease_quantity);
        increaseButton = (ImageButton) findViewById(R.id.increase_quantity);
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_NAME)));
        priceEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_PRICE)));
        quantityEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_QUANTITY)));
        supplierNameEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEditText.setText(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(PhoneContract.PhoneEntry.COLUMN_IMAGE))));
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(PhoneContract.PhoneEntry.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                PhoneContract.PhoneEntry.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
